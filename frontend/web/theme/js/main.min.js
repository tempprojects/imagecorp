...
jQuery(function ($) {
    ...
    /* *
     * show category nav list
     * */

    var categoryBtn = $('.category-nav .current-category'),
        categoryList = $('.category-nav .category-list');
    ...
    categoryList.on('click', 'li', function () {
        var cat = categoryBtn.text(),
            catNew = $(this).text();

        categoryList.slideToggle(100);
        $(this).text(cat);
        categoryBtn.text(catNew);
    });
