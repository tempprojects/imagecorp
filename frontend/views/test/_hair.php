                                ...
                                <?php for($j=($i-1)*2 + $firstSectionCnt; $j<(($i-1)*2 + 2*$firstSectionCnt); $j++): ?>
                                    ...
                                    <?php $outputSectionsCnt++?>
                                        <div class="column is-flex">
                                            <div class="box">
                                                    <div class="is-block"><img src="<?= isset($answers[$j]) ? ($answers[$j]->mainImage ? $answers[$j]->mainImage->getAttribute("src") : "") : "" ?>" alt="">
                                                    </div>
                                                    <div class="is-block">
                                                            <div class="is-text-centered pad-top">
                                                                    <input type="radio" id="r<?= $j ?>" name="eye<?= $i+1?>">
                                                                    <label for="r<?= $j ?>"><span></span></label>
                                                            </div>
                                                    </div>
                                            </div>
                                        </div>
