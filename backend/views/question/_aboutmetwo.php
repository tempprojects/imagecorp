...
<div class="question-form">
    ...
    <?php 
        ...
        echo "<div class='col-md-4'>";
            ...
            echo $form->field($value, '[' . $key . ']main_image_id')->hiddenInput(['maxlength' => true])->label('Photo #1');
            echo Gallery::widget(['type' => 'tests', 'idInput' => 'answer-'.$key.'-main_image_id', 'img' => $img]);

        

            $img = is_object($value->subImage)?$value->subImage->getAttribute('src'): null;
            echo $form->field($value, '[' . $key . ']sub_image_id')->hiddenInput()->label('Photo #2');
            echo Gallery::widget(['type' => 'tests', 'idInput' => 'answer-'.$key.'-sub_image_id', 'img' => $img]);
